...
namespace ThreadHaven.Controllers
{
    public class ProductsController : Controller
    {
        ...
        {
            // add sorting by product name to query
        ...
        public async Task<IActionResult> Create([Bind("ProductId,Name,Description,Price,Size,CategoryId")] Product product, IFormFile? Photo)
        {
